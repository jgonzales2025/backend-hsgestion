...
class ArticleForSalesResource extends JsonResource
{
    public function toArray($request): array
    {
        ...
        return [
            ...
            'purchase_price_pen' => $this->resource->getPurchasePricePen(),
            'public_price_pen' => $this->resource->getPublicPricePen(),
            'distributor_price_pen' => $this->resource->getDistributorPricePen(),
            'authorized_price_pen' => $this->resource->getAuthorizedPricePen(),
            'purchase_price_usd' => $this->resource->getPurchasePriceUsd(),
            'public_price_usd' => $this->resource->getPublicPriceUsd(),
            'distributor_price_usd' => $this->resource->getDistributorPriceUsd(),
            'authorized_price_usd' => $this->resource->getAuthorizedPriceUsd(),
