...
use App\Modules\CustomerPortfolio\Application\UseCases\UpdateCustomerPortfolioUseCase;
...
class CustomerPortfolioController extends Controller
{
    ...
    public function update(UpdateCustomerPortfolioRequest $request): JsonResponse
    {
        $customerPortfolioDTO = new UpdateCustomerPortfolioDTO($request->validated());
        $customerPortfolioUseCase = new UpdateCustomerPortfolioUseCase($this->customerPortfolioRepository);
