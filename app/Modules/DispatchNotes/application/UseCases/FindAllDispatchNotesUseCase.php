...
class FindAllDispatchNotesUseCase
{
    ...
    public function execute(?string $description, ?int $status, ?int $emissionReasonId, ?string $estadoSunat = null)
    {
        return $this->dispatchNotesRepositoryInterface->findAll($description, $status, $emissionReasonId, $estadoSunat);
    }
}
