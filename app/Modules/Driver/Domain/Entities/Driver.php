...
class Driver
{
     ...
     */
    public function __construct(int $id, int $customer_document_type_id, string $doc_number, string $name, string $pat_surname, string $mat_surname, bool $status, string $license, ?string $document_type_name)
    {
        $this->id = $id;
