...
class CreatePurchaseRequest extends FormRequest
{
  ...
  public function rules(): array
  {
    return [
      ...
      'det_compras_guia_ingreso.*.precio_costo' => 'nullable|numeric|gt:0',
      'det_compras_guia_ingreso.*.descuento' => 'nullable|numeric|min:0',
      'det_compras_guia_ingreso.*.sub_total' => 'nullable|numeric|gt:0',
