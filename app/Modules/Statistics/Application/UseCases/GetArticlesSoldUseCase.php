...
class GetArticlesSoldUseCase
{
    ...
    public function execute(int $company_id, ?int $branch_id, ?string $start_date, ?string $end_date, ?int $category_id, ?int $brand_id)
    {
        return $this->statisticsRepository->getArticlesSold($company_id, $branch_id, $start_date, $end_date, $category_id, $brand_id);
    }
}