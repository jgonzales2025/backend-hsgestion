...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Menu::create([
            ...
            'permission' => 'estadisticas.precios_compra_articulo',
            'parent_id' => $estadistica->id,
            'order' => 8,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'estadisticas.ventas_productos',
            'parent_id' => $estadistica->id,
            'order' => 10,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'reportes.kardex_valorizado',
            'parent_id' => $reporte->id,
            'order' => 2,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'reportes.kardex_precio_real',
            'parent_id' => $reporte->id,
            'order' => 4,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'reportes.entrada_salida_articulo',
            'parent_id' => $reporte->id,
            'order' => 10,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'reportes.registro_documentos',
            'parent_id' => $reporte->id,
            'order' => 11,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            'name' => 'reportes_consulta_en_linea',
        ...
        Menu::create([
            ...
            'permission' => 'garantias.envios_proveedor',
            'parent_id' => $garantia->id,
            'order' => 2,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'garantias.guias_remision_garantia',
            'parent_id' => $garantia->id,
            'order' => 6,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'mantenimiento.documentos_venta',
            'parent_id' => $mantenimiento->id,
            'order' => 2,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'mantenimiento.ordenes_salida_traslado',
            'parent_id' => $mantenimiento->id,
            'order' => 4,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'mantenimiento.guias_ordenes_salida_traslado',
            'parent_id' => $mantenimiento->id,
            'order' => 5,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'mantenimiento.ordenes_consignacion_traslado',
            'parent_id' => $mantenimiento->id,
            'order' => 6,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'mantenimiento.anular_documentos_venta',
            'parent_id' => $mantenimiento->id,
            'order' => 7,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'actualizaciones.ultimo_costo',
            'parent_id' => $actualizacion->id,
            'order' => 2,
            'status' => 1,
            'type' => 'item',
        ...
        Menu::create([
            ...
            'permission' => 'actualizaciones.saldos_clientes',
            'parent_id' => $actualizacion->id,
            'order' => 3,
            'status' => 1,
            'type' => 'item',
