...
<head>
    ...
    <style>
        ...
        main {
            padding-top: 3.5cm;
            /* reserva espacio para el header */
            margin-left: 1.5cm;
            margin-right: 1.5cm;
            margin-bottom: 2cm;
        }
            ...
            <table class="info-table">
                ...
                @else
                    <tr>
                        ...
                        <td>{{ $customer->getName() }} {{ $customer->getLastname() }} {{ $customer->getSecondLastname() }}
                        </td>
                    </tr>
                @endif
                ...
                <div style="float: left; width: 55%; padding-right: 10px;">
                    @if($sale->getPorretencion() > 0)
                        <div style="border: 1px solid #000; padding: 5px; font-size: 9px;">
                            <div style="font-weight: bold; text-decoration: underline; margin-bottom: 2px;">Información de
                                la
                                retención</div>
                            ...
                            <div><span style="font-weight: bold;">Monto de la Retención :</span>
                                {{ $sale->getCurrencyType()->getCommercialSymbol() }}
                                {{ number_format($retentionAmount, 2) }}
                            </div>
                        </div>
                    @elseif($sale->getCoddetrac())
                        <div style="border: 1px solid #000; padding: 5px; font-size: 8px;">
                            <div style="font-weight: bold; text-decoration: underline; margin-bottom: 2px;">Información de
                                la
                                detracción</div>
                            <div style="margin-bottom: 2px;"><span style="font-weight: bold;">Leyenda :</span> Operación
                                sujeta
                    ...
                    <table style="width: 100%; border: 1px solid #333; margin-top: 0px;">
                        ...
                        <tbody>
                            <tr style="background-color: #f9f9f9;">
                                ...
                                <td
                                    style="padding: 8px; text-align: center; font-weight: bold; background-color: #eee;">
                                    {{ $sale->getCurrencyType()->getCommercialSymbol() }}
                                    {{ number_format($sale->getTotal(), 2) }}
                                </td>
                            </tr>
                    ...
                    <tr>
                                ...
                                <table style="width: 100%; margin-bottom: 3px;">
                                    <tr>
                                        <td style="width: 50%; vertical-align: top; padding-right: 5px;">
                                            <div
                                                style="font-weight: bold; font-size: 7px; margin-bottom: 1px; color: #000;">
                                ...
                                <div style="border-top: 1px solid #ddd; padding-top: 4px; margin-top: 4px;">
                                    ...
                                    <table style="width: 100%; margin-bottom: 3px;">
                                        <tr>
                                            <td style="width: 50%; vertical-align: top; padding-right: 5px;">
                                                <div
                                                    style="font-weight: bold; font-size: 6px; margin-bottom: 1px; color: #333;">
                                                    Soles:
                                                </div>
                                                <div style="font-size: 6px; margin-bottom: 0px;">
                                                    <span style="font-weight: bold;">Banco BBVA:</span>
                                                    01117500010009977577
                                                </div>
                                                <div style="font-size: 6px; margin-bottom: 0px;">
                                                    <span style="font-weight: bold;">Banco BCP:</span>
                                                    00219100731923607555
                                                </div>
                                            </td>
                                            <td
                                                style="width: 50%; vertical-align: top; padding-left: 5px; border-left: 1px solid #ddd;">
                                                ...
                                                <div style="font-size: 6px; margin-bottom: 0px;">
                                                    <span style="font-weight: bold;">Banco BBVA:</span>
                                                    01117500010009978371
                                                </div>
                                                <div style="font-size: 6px; margin-bottom: 0px;">
                                                    <span style="font-weight: bold;">Banco BCP:</span>
                                                    00219100732010910357
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <div
                                        style="background-color: #fff3cd; border: 1px solid #ffc107; padding: 3px; margin-top: 3px; border-radius: 3px;">
                                        <div style="font-size: 6px; color: #856404; line-height: 1.1;">
                                            ...
                                            Verificar antes de confirmar abono que indique <strong>CYBERHOUSE TEC
                                                SAC</strong> en su
                                            aplicación, caso contrario la mercadería será entregada una vez verificado
                                            el
                                            abono en
                                            nuestras cuentas.
                                        </div>
                        ...
                        @if(!in_array($sale->getDocumentType()->getId(), [16, 17]))
                            <td style="width: 35%; vertical-align: top; padding-left: 5px; text-align: center;">
                                <div
                                    style="border: 1px solid #ddd; padding: 4px; border-radius: 5px; background-color: #f9f9f9;">
