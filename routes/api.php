...
Route::middleware(['auth:api', 'auth.custom'])->group(function () {
    ...
    Route::get('/logs-transaction/document', [TransactionLogController::class, 'findByDocument']);
    ...
    Route::get('document-types/cobranzas', [DocumentTypeController::class, 'documentTyePurchase']);
    // Banks - Bancos
